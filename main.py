...
if __name__ == "__main__":
    ...
    MQTT_VERSION = os.getenv("MQTT_VERSION")
    BROKER_AUTH_USERNAME = os.getenv("BROKER_AUTH_USERNAME")
    BROKER_AUTH_PASSWORD = os.getenv("BROKER_AUTH_PASSWORD")
    ...
    if BROKER_TYPE in ("redis", "REDIS", "Redis"):
        ...
        print(f"Not a valid BROKER_TYPE ({BROKER_TYPE}) was given!")
        sys.exit(1)

    proxy = RESTProxy("proxy.rest", conn_params, debug=False)
